...
<body class="h-auto bg-[Gray]">
    ...
    <body class="h-auto bg-[Gray]">
        ...
        <div class=" relative top-[50px]">
            <h1 class="text-[38px] text-[White] font-bold text-center pt-[60px]">View Expences</h1>
            ...
            <div class="relative top-[30px] left-[1080px]  bg-green-500 w-[150px] h-[50px] rounded-full cursor-pointer">
                <a class="text-[16px] text-[white] font-semibold text-center relative top-[13px] left-[20px]" href="addEmp.php">Add Expences</a>
            </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Expences Name</th>
                        ...
                        <tbody id="dataTable">                           
                            <?php
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4"><?php echo $row['Exp_Name']; ?></td>
                                    <td class="px-6 py-4">Rs.<?php echo $row['Amount']; ?></td>                                    
                                </tr>
