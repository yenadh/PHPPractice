...
<body class="h-auto bg-[Gray]">
    ...
    <h1 class="text-[38px] text-[White] font-bold text-center relative top-[50px] pt-[60px]">Add User</h1>
        ...
        <div class="flex flex-col text-[20px]">
            <form method="post" autocomplete="off">
                <div class="py-[20px]">
                    ...
                    <input type="text" name="txtUserName" class="w-[500px] h-[40px] text-[18px] pl-[10px] border-[2px] border-[#cccaca]" required="" autocomplete="off" >
                </div>

                <div class="py-[20px]">
                    <label class="pr-[20px]">Password</label>
                    <input type="password" name="txtPassword" class="w-[500px] h-[40px] text-[18px] px-[10px] border-[2px] border-[#cccaca]" required="" autocomplete="false">
                </div>
